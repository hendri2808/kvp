...
These data types are defined in `kvp/primitives/src/v1.rs`:
...
digraph {
    ...
    Id [label="kvp_parachain::primitives::Id"]
    CollatorId [label="kvp_primitives::v2::CollatorId"]
    ...
    TransientValidationData:balance -> "kvp_core_primitives::v2::Balance":w
    ...
    CandidateCommitments:upward_messages -> "kvp_parachain::primitives::UpwardMessage":w
    CandidateCommitments:horizontal_messages -> "kvp_core_primitives::v2::OutboundHrmpMessage":w
    CandidateCommitments:head_data -> HeadData:w
    CandidateCommitments:horizontal_messages -> "kvp_parachain::primitives::Id":w
    CandidateCommitments:new_validation_code -> "kvp_parachain::primitives::ValidationCode":w
    ...
    PoV:block_data -> "kvp_parachain::primitives::BlockData":w
    ...
    BackedCandidate:validity_votes  -> "kvp_primitives:v0:ValidityAttestation":w

    HeadData [label = "kvp_parachain::primitives::HeadData"]
    ...
    ValidatorId [label = "kvp_primitives::v2::ValidatorId"]
    AuthorityDiscoveryId [label = "sp_authority_discovery::AuthorityId"]
    ValidatorIndex [label = "kvp_primitives::v2::ValidatorIndex"]
...
These data types are defined in `kvp/parachain/src/primitives.rs`:
...
digraph {
    ...
    RelayChainBlockNumber [label = "kvp_core_primitives::BlockNumber"]
    ...
    OutboundHrmpMessage [label = "kvp_core_primitives::OutboundHrmpMessage"]
}
```
