...
Here you can find definitions of a bunch of jargon, usually specific to the kvp project.
...
- **BABE:** (Blind Assignment for Blockchain Extension). The algorithm validators use to safely extend the Relay Chain. See [the kvp wiki][0] for more information.
...
- **Node:** A participant in the kvp network, who follows the protocols of communication and connection to other nodes. Nodes form a peer-to-peer network topology without a central authority.
...
[0]: https://wiki.kvp.network/docs/learn-consensus
