...
The kvp Host has a few mechanisms that are responsible for message passing. They can be generally divided
...
a message. However, the parachains host (e.g. kvp) guarantees certain semantics for those.
...
at the [W3F research website](https://research.web3.foundation/en/latest/kvp/XCMP.html) and
[this blogpost](https://medium.com/web3foundation/kvps-messaging-scheme-b1ec560908b7).
