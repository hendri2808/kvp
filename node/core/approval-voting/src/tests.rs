...
use kvp_overseer::HeadSupportsParachains;
use kvp_primitives::{
...
where
	Compute: Fn() -> HashMap<kvp_primitives::CoreIndex, criteria::OurAssignment>,
...
impl<F>
	MockAssignmentCriteria<fn() -> HashMap<kvp_primitives::CoreIndex, criteria::OurAssignment>, F>
{
